...
(setq gptel-model 'deepseek/deepseek-v3.2
	gptel-backend (gptel-make-openai "OpenRouter"               ;Any name you want
									...
									:models '(z-ai/glm-4.5-air deepseek/deepseek-v3.2 qwen/qwen3-235b-a22b google/gemini-2.0-flash-001 deepseek/deepseek-chat-v3-0324 qwen/qwen-2.5-coder-32b-instruct meta-llama/llama-3.3-70b-instruct)))
