  ...
  (when (string= setting "color-scheme")
    (let ((scheme (car values)))
	  ...
	  (use-package doom-themes
	    ...
	    (+org-todo-active    ((t (:foreground "#FFFFFF" :background "#90A4AE"))))
	    (+org-todo-cancel    ((t (:foreground "#FFFFFF" :background "#90A4AE"))))
	    (+org-todo-onhold    ((t (:foreground "#FFFFFF" :background "#90A4AE"))))
	    (+org-todo-project    ((t (:foreground "#FFFFFF" :background "#90A4AE"))))
